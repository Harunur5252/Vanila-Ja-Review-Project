...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _modules_ui__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/ui */ \"./src/modules/ui.js\");\n/* harmony import */ var _styles_style_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./styles/style.css */ \"./src/styles/style.css\");\n\n\n_modules_ui__WEBPACK_IMPORTED_MODULE_0__.default.loadAllEventListener();\n\n//# sourceURL=webpack://my-webpack-project/./src/index.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _data__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./data */ \"./src/modules/data.js\");\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\n\n\nvar UI = /*#__PURE__*/function () {\n  function UI() {\n    _classCallCheck(this, UI);\n  }\n\n  _createClass(UI, [{\n    key: \"selectors\",\n    value: function selectors() {\n      var setItemElm = document.querySelector('.setItem');\n      var cirImgElm = document.querySelector('.cirImg');\n      var nameElm = document.querySelector('.name');\n      var titleElm = document.querySelector('.title');\n      var textElm = document.querySelector('.text');\n      var leftIconElm = document.querySelector('.leftIcon');\n      var rightIconElm = document.querySelector('.rightIcon');\n      var sBtnElm = document.querySelector('.sBtn');\n      return {\n        setItemElm: setItemElm,\n        cirImgElm: cirImgElm,\n        nameElm: nameElm,\n        titleElm: titleElm,\n        textElm: textElm,\n        leftIconElm: leftIconElm,\n        rightIconElm: rightIconElm,\n        sBtnElm: sBtnElm\n      };\n    }\n  }, {\n    key: \"showPerson\",\n    value: function showPerson(item) {\n      var _this$selectors = this.selectors(),\n          cirImgElm = _this$selectors.cirImgElm,\n          nameElm = _this$selectors.nameElm,\n          titleElm = _this$selectors.titleElm,\n          textElm = _this$selectors.textElm;\n\n      var elm = _data__WEBPACK_IMPORTED_MODULE_0__.default.reviews[item];\n      cirImgElm.src = elm.image;\n      nameElm.textContent = elm.name;\n      titleElm.textContent = elm.profession;\n      textElm.textContent = elm.description;\n    }\n  }, {\n    key: \"loadAllEventListener\",\n    value: function loadAllEventListener() {\n      var _this$selectors2 = this.selectors(),\n          rightIconElm = _this$selectors2.rightIconElm,\n          leftIconElm = _this$selectors2.leftIconElm,\n          sBtnElm = _this$selectors2.sBtnElm;\n\n      window.addEventListener('DOMContentLoaded', function () {\n        return _data__WEBPACK_IMPORTED_MODULE_0__.default.domLoaded();\n      });\n      rightIconElm.addEventListener('click', function () {\n        return _data__WEBPACK_IMPORTED_MODULE_0__.default.getRightIconData();\n      });\n      leftIconElm.addEventListener('click', function () {\n        return _data__WEBPACK_IMPORTED_MODULE_0__.default.getLeftIconData();\n      });\n      sBtnElm.addEventListener('click', function () {\n        return _data__WEBPACK_IMPORTED_MODULE_0__.default.getRandomValue();\n      });\n    }\n  }]);\n\n  return UI;\n}();\n\nvar ui = new UI();\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ui);\n\n//# sourceURL=webpack://my-webpack-project/./src/modules/ui.js?");
